...
MIDDLEWARE = [ #Implementing the per site caching which caches the whole site
...
#Setting the internal ips so as it matches the address on docker machine for django-debug-toolbar
import socket
